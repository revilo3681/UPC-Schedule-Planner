...
interface HeaderNavbarProps {
  ...
  activeView: 'grid' | 'list' | 'table' | 'auto' | 'profes';
  onViewChange: (view: 'grid' | 'list' | 'table' | 'auto' | 'profes') => void;
  stats: ScheduleStats;
  onOpenImport: () => void;
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              >
                <span className="text-slate-400 dark:text-slate-500">creado por:</span>
